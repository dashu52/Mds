...
public class SpUtils {
    ...
    public static boolean SetConfigString(String keyanme, String keyvalue) {
        ...
        try
        {
            ...
            SharedPreferences mySharedPreferences= APP.getContext().getSharedPreferences(spFileName, Activity.MODE_PRIVATE);
    ...
    public static String GetConfigString(String keyanme)
    {
        ...
        try
        {
            SharedPreferences sharedPreferences= APP.getContext().getSharedPreferences(spFileName, Activity.MODE_PRIVATE);
     ...
     //       MyLogger.dLog().d(strout);
            //Toast.makeText(context, strout,Toast.LENGTH_LONG).show();
            MyLogger.dLog().d("我没异常----我取数据"+keyanme+" -------"+resultvalue);
        }
        catch(Exception ex)
        {
            MyLogger.dLog().d("我异常了");
            ex.printStackTrace();
    ...
    public static Boolean getBoolean(String strKey,
                                     Boolean strDefault) {
        SharedPreferences setPreferences = APP.getContext().getSharedPreferences(
    ...
    public static void putBoolean( String strKey,
                                  Boolean strData) {
        SharedPreferences activityPreferences = APP.getContext().getSharedPreferences(
                spFileName, Context.MODE_PRIVATE);
